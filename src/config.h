...
#  error "NTP_SERVER not set — add '-DNTP_SERVER=\"pool.ntp.org\"' to [private_credentials] in platformio_user.ini"
#endif
#ifndef NTP_SERVER
#  define NTP_SERVER  ""
#endif
...
#  error "TIMEZONE not set — add '-DTIMEZONE=\"CET-1CEST,M3.5.0,M10.5.0/3\"' to [private_credentials] in platformio_user.ini"
#endif
#ifndef TIMEZONE
#  define TIMEZONE  ""
#endif
...
#  error "WIFI_SSID not set — add '-DWIFI_SSID=\"your_ssid\"' to [private_credentials] in platformio_user.ini"
#endif
#ifndef WIFI_SSID
#  define WIFI_SSID  ""
#endif
...
#  error "WIFI_PASS not set — add '-DWIFI_PASS=\"your_password\"' to [private_credentials] in platformio_user.ini"
#endif
#ifndef WIFI_PASS
#  define WIFI_PASS  ""
#endif
...
#  error "SWITCHBOT_MAC not set — add '-DSWITCHBOT_MAC=\"aa:bb:cc:dd:ee:ff\"' to [private_credentials] in platformio_user.ini"
#endif
