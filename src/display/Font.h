...
public:
    ...
    /// Glyph indices.
    static constexpr uint8_t IDX_COLON = 10u;  ///< ':'
    static constexpr uint8_t IDX_DASH = 11u;   ///< '-'
    static constexpr uint8_t IDX_DEGREE = 12u; ///< '°'

    /// FONT[fontIdx][row] — indices 0–9 = digits, 10 = ':', 11 = '-', 12 = '°'.
    static constexpr uint8_t FONT[COUNT][GLYPH_ROWS] = {
